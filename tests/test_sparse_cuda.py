"""
    The code for this test example was copied from test_sparse.py
"""
...
class TestSparseMatrix:
    ...
    # CudaExecutor usage
    ref = pyGinkgo.CudaExecutor(0, pyGinkgo.ReferenceExecutor())
    ...
    def test_can_apply_to_dense(self, matrix_format):
        ...
        # Othervise we cannot access the elements of the matrix
        dense_x = dense_x.copy_to_host()
